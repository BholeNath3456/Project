...
public class MyRewardAdapter extends RecyclerView.Adapter<MyRewardAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull Viewholder viewholder, int position) {
        ...
        viewholder.setData(type, validity, body, upperLimit, lowerLimit, discOramt,position);
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        private void setData(String type, Date validity, String body, String upperLimit, String lowerLimit, String discOramt,int position) {
            ...
            if (useMiniLayout) {
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ProductDetailsActivity.selectedRewardId =DBqueries.rewardModelList.get(position).getRewardID();
                    }
                });
            }
        }
