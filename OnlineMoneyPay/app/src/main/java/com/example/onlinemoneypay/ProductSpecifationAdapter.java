...
public class ProductSpecifationAdapter extends RecyclerView.Adapter<ProductSpecifationAdapter.ViewHolder> {
    ...
    @Override
    public ProductSpecifationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        switch (viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductSpecifationAdapter.ViewHolder viewHolder, int position) {
        switch (productSpecificationModelList.get(position).getType()) {
            case ProductSpecificationModel.SPECIFICATION_TITLE:
